...
public class TableService : ITableService
{
    ...
    public async Task AddTable(string tableNo)
    {
        ...
        // Set StartTime to null for initially not occupied tables for better semantic meaning
        var table = new Table { No = tableNo, IsOcupied = false, StartTime = null };
    ...
    public async Task UpdateTableStatus(int id, bool isOccupied)
    {
        ...
        // Set StartTime to DateTime.Now when occupied, or null when vacated
        table.StartTime = isOccupied ? DateTime.Now : null;
